...
<link rel="stylesheet" href="/ShibaFolder2/css/admin.css">
</head>
<body>
 <header>
...
<tr>
<td>${s.id }</td>
<td><img src="/ShibeFolder2/upload/${s.imgname }"></td>
<td>${s.title}</td>
<td>${s.memo}</td>
<td>
<a href="/ShibeFolder2/Admin/Update?id=${s.id}">更新</a>
</td>
<td>
<a href="/ShibeFolder2/Admin/Delete?id=${s.id}" onclick="return confirm('削除しますか？')">削除</a>
</td>
</tr>
</c:forEach>
</table>
